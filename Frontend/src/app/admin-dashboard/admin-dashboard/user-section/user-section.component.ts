...
export class UserSectionComponent implements OnInit {
  ...
  constructor(private HttpClient: HttpClient, private userService:UsersService, private toastrService: ToastrService, private ngxSpinnerService: NgxSpinnerService) { }
